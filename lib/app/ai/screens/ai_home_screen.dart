    ...
    return Scaffold(
            ...
            if (_isMarketMode) ...[
              ...
              Container(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(PhosphorIconsRegular.basket, size: 12, color: theme.colorScheme.onSurfaceVariant),
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (context) => [
              PopupMenuItem(
                ...
                child: Row(
                  children: [
                    Icon(_isMarketMode ? PhosphorIconsRegular.chatCircle : PhosphorIconsRegular.basket, size: 20),
              ...
              children: [
                GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    child: Row(
                      children: [
                        Icon(PhosphorIconsRegular.basket, size: 16, color: theme.colorScheme.primary),
      ...
      floatingActionButton: _isMarketMode
          ? FloatingActionButton(
              ...
              child: const Icon(PhosphorIconsRegular.chat),
            )
          : null,
    );
  }
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                    Icon(PhosphorIconsRegular.basket, size: 24, color: theme.colorScheme.onSurfaceVariant),
                  const SizedBox(width: Spacing.sm),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  if (allPurchased)
                    const Icon(PhosphorIconsRegular.checkCircle, color: Colors.green, size: 32)
                        .animate()
