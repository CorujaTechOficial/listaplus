...
const createRecipeTool = AgentTool(
  name: 'create_recipe',
  description:
      'Cria uma nova receita no livro de receitas do usuário. '
  ...
  parameters: [
    ...
    AgentToolParameter(
      ...
      type: 'string',
      description:
          'JSON string de lista de itens. Estrutura: [{"name": "string", "quantity": num, '
    ...
    AgentToolParameter(
      ...
      type: 'string',
      description:
          'Lista de strings contendo os passos da receita (separados por ponto e vírgula ou vírgula)',
      required: true,
    ),
    AgentToolParameter(
