...
const generateArtifactTool = AgentTool(
  ...
  description:
      'Gera um artefato interativo e reativo de interface (GenUI) no chat. '
  ...
  parameters: [
    ...
    AgentToolParameter(
      name: 'icon',
      type: 'string',
      description: 'Emoji representando o artefato',
      required: true,
    ),
    AgentToolParameter(
      name: 'description',
    ...
    AgentToolParameter(
      name: 'controls',
      type: 'string',
      description: 'JSON string com lista de controles interativos',
      required: true,
    ),
    AgentToolParameter(
      name: 'items',
      type: 'string',
      description: 'JSON string com lista de itens',
      required: true,
    ),
    AgentToolParameter(
      name: 'baseServings',
      type: 'number',
      description: 'Quantidade base de porções',
      required: true,
    ),
    AgentToolParameter(
      name: 'budget',
    ...
    AgentToolParameter(
      name: 'showBudgetBar',
      type: 'boolean',
      description: 'Renderiza barra de orçamento',
      required: false,
    ),
    AgentToolParameter(
      name: 'commitLabel',
    ...
    AgentToolParameter(
      name: 'commitMode',
      type: 'string',
      description: 'Modo de inserção: "addAll" ou "addMissing"',
      required: false,
    ),
  ],
);
