...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get chatEmptySubtitle =>
      'Ζητήστε προτάσεις προϊόντων, συνταγές ή συμβουλές αποθήκευσης για να ξεκινήσετε.';

  @override
  String get chatEmptyTitle => 'Η συνομιλία σας είναι άδεια';
  ...
  String aiUsageWarning(int remaining) {
    return '$remaining Απομένουν ενέργειες AI αυτόν τον μήνα — αναβάθμιση για απεριόριστη';
  }
  ...
  @override
  String get onboardingMaybeLater => 'Ίσως αργότερα';

  @override
  String paywallHeroSubtitlePersonalized(String name) {
    return 'Γεια $name, οργανώστε τις αγορές σας με τον σωστό τρόπο.';
  }

  @override
  String get onboardingSlide1Title => 'Έξυπνες λίστες αγορών';

  @override
  String get onboardingSlide1Body =>
      'Δημιουργήστε και μοιραστείτε λίστες αμέσως. Η Kipi προσθέτει αντικείμενα αυτόματα με βάση τις συνήθειές σας.';

  @override
  String get onboardingSlide2Title => 'Γνωρίστε τον Kipi';

  @override
  String get onboardingSlide2Body =>
      'Ρωτήστε οτιδήποτε — δημιουργήστε λίστες, βρείτε συνταγές, παρακολουθήστε το ντουλάπι σας, προγραμματίστε την εβδομάδα σας.';

  @override
  String get onboardingSlide3Title => 'Σχεδιασμός φαγητού & γευμάτων';

  @override
  String get onboardingSlide3Body =>
      'Παρακολουθήστε τι έχετε, προγραμματίστε γεύματα και δημιουργήστε αυτόματα λίστες αγορών.';
  ...
  @override
  String get paywallTrialTitle => 'Δοκιμάστε δωρεάν!';

  @override
  String get paywallTrialSubtitle =>
      'Ακύρωση ανά πάσα στιγμή. Χωρίς χρέωση σήμερα.';

  @override
  String get paywallTrialCta => 'Ξεκινήστε τη δωρεάν δοκιμή';
  ...
  String get noListSelected =>
      'Δεν έχει επιλεγεί λίστα. Ανοίξτε πρώτα μια λίστα.';
  ...
  String get paywallFeatureDescAssistant =>
      'Το AI οργανώνει τη λίστα σας αυτόματα';

  @override
  String get paywallFeatureDescUnlimitedLists =>
      'Δημιουργήστε όσες λίστες χρειάζεστε';

  @override
  String get paywallFeatureDescSharing => 'Αγοράστε μαζί σε πραγματικό χρόνο';

  @override
  String get paywallFeatureDescPantry => 'Παρακολουθήστε τι έχετε στο σπίτι';

  @override
  String get paywallFeatureDescBudget => 'Μείνετε στον προϋπολογισμό κάθε μήνα';
  ...
  String paywallTrialInCard(int days) {
    return 'Οι πρώτες $days ημέρες ΔΩΡΕΑΝ';
  }

  @override
  String get paywallSecuredByStore =>
      'Προστατεύεται από το Google Play · Ακύρωση ανά πάσα στιγμή';
  ...
  @override
  String get consentTitle => 'Απόρρητο και Analytics';

  @override
  String get consentBody =>
      'Το KipiList χρησιμοποιεί το Firebase Analytics για να βελτιώσει την εμπειρία σας. Τα δεδομένα σας υποβάλλονται σε επεξεργασία σύμφωνα με την Πολιτική Απορρήτου μας.';

  @override
  String get consentAccept => 'Αποδέχομαι';

  @override
  String get consentDecline => 'Όχι, ευχαριστώ';

  @override
  String get mealPlannerPantryAllAvailable => 'Όλα τα συστατικά διαθέσιμα';
  ...
  @override
  String get notInformed => 'Δεν έχει οριστεί';
  ...
  String get onboardingAiGreeting =>
      'Γεια! Είμαι η Kipi, η προσωπική σας βοηθός αγορών! 🛒';

  @override
  String get onboardingAiAskName => 'Πώς σε λένε;';

  @override
  String get onboardingAiNameHint => 'Πληκτρολογήστε το όνομά σας...';

  @override
  String onboardingAiNiceToMeet(String name) {
    return 'Χαίρομαι που σε γνωρίζω, $name! 🎉';
  }

  @override
  String get onboardingAiAskFood => 'Ποιο είναι το αγαπημένο σου φαγητό;';

  @override
  String get onboardingAiFoodHint => 'π.χ. Πίτσα, σούσι...';

  @override
  String onboardingAiIngredients(String ingredients) {
    return 'Υπέροχες επιλογές! Να τι θα προσθέσω στη λίστα σας:\n\n$ingredients\n\n---';
  }

  @override
  String get onboardingAiAskConfirm =>
      'Αυτό φαίνεται καλό; Δοκιμάστε να πληκτρολογήσετε κάτι άλλο!';

  @override
  String get onboardingAiReady =>
      'Μεγάλος! Είστε έτοιμοι να ξεκινήσετε. Ας δημιουργήσουμε τον λογαριασμό σας!';

  @override
  String get onboardingAiContinue => 'Συνέχεια →';
  ...
  @override
  String get backToToday => 'Επιστροφή στο σήμερα';

  @override
  String get quickSuggestions => 'Γρήγορες προτάσεις';

  @override
  String get aiEnergyLow => 'Χαμηλή ενέργεια AI';

  @override
  String get aiUnlockUnlimited => 'Ξεκλειδώστε απεριόριστο AI';
  ...
  String aiRemainingFreeToday(int remaining) {
    ...
    return '$remaining $_temp0 σήμερα';
  }

  @override
  String get aiSubscribeUnlimited => 'Εγγραφείτε για απεριόριστο AI';

  @override
  String get unlockWithAd => 'Ξεκλείδωμα με διαφήμιση';

  @override
  String get conversationHistoryTitle => 'Ιστορικό συνομιλίας';

  @override
  String get noConversationsFound => 'Δεν βρέθηκαν συνομιλίες';

  @override
  String get errorLoadingHistory => 'Σφάλμα κατά τη φόρτωση του ιστορικού';
  ...
  @override
  String get deleteConversation => 'Διαγράφω';
  ...
  @override
  String get unlockPremiumTitle => 'Ξεκλείδωμα Premium';

  @override
  String get loadingSubscription => 'Φόρτωση συνδρομής...';

  @override
  String get errorLoadingSubscription => 'Σφάλμα κατά τη φόρτωση της συνδρομής';
  ...
  @override
  String get profileSubtitle => 'Τα στοιχεία του προφίλ σας';

  @override
  String get customizeAiAssistant => 'Προσαρμόστε τον βοηθό AI';

  @override
  String get assistantHistory => 'Ιστορικό βοηθού';

  @override
  String get assistantHistorySubtitle => 'Δείτε το ιστορικό συνομιλιών σας';
  ...
  String get manageCategoriesSubtitle =>
      'Προσθήκη, επεξεργασία ή κατάργηση κατηγοριών';

  @override
  String get customizeAssistant => 'Προσαρμογή';

  @override
  String get assistantName => 'Όνομα βοηθού';

  @override
  String get chooseIcon => 'Επιλέξτε εικονίδιο';

  @override
  String get profileSaved => 'Το προφίλ αποθηκεύτηκε';

  @override
  String get errorSavingProfile => 'Σφάλμα αποθήκευσης προφίλ';

  @override
  String get userProfile => 'Προφίλ χρήστη';

  @override
  String get profileDescription => 'Περιγραφή προφίλ';

  @override
  String get preferredMarket => 'Προτιμώμενη αγορά';

  @override
  String get preferredMarketHint => 'Πού ψωνίζετε συνήθως;';

  @override
  String get dietaryRestrictions => 'Διατροφικοί περιορισμοί';

  @override
  String get dietaryRestrictionsHint => 'Υπάρχουν διατροφικοί περιορισμοί;';

  @override
  String get marketsToAvoid => 'Αγορές προς αποφυγή';

  @override
  String get marketsToAvoidHint =>
      'Αγορές στις οποίες προτιμάτε να μην ψωνίζετε';

  @override
  String get observations => 'Παρατηρήσεις';

  @override
  String get observationsHint => 'Κάποιες επιπλέον σημειώσεις;';

  @override
  String get saveProfile => 'Αποθήκευση προφίλ';

  @override
  String get everythingReady => 'Όλα έτοιμα!';

  @override
  String get youCompletedList => 'Ολοκληρώσατε τη λίστα!';

  @override
  String get selectCheaperAlternative => 'Επιλέξτε φθηνότερη εναλλακτική';

  @override
  String get suggestedItems => 'Προτεινόμενα είδη';

  @override
  String get swapped => 'Ανταλλάχθηκε';

  @override
  String get swap => 'Ανταλαγή';

  @override
  String get chooseThemeColor => 'Επιλέξτε χρώμα θέματος';

  @override
  String get manageCategoriesTitle => 'Διαχείριση κατηγοριών';

  @override
  String get categoryLimitReached => 'Συμπληρώθηκε το όριο κατηγορίας';
  ...
  String deleteCategoryConfirm(String category) {
    return 'Τα στοιχεία στο \"$category\" θα μετακινηθούν στα \"Άλλα\".\nΣυνεχίζω;';
  }

  @override
  String get deleteCategory => 'Διαγράφω';

  @override
  String get newCategoryDialog => 'Νέα κατηγορία';

  @override
  String get editCategoryDialog => 'Επεξεργασία κατηγορίας';

  @override
  String get categoryName => 'Όνομα κατηγορίας';

  @override
  String get categoryNameHint => 'Εισαγάγετε το όνομα της κατηγορίας';

  @override
  String get categoryColorLabel => 'Χρώμα';

  @override
  String get categoryIconLabel => 'Εικόνισμα';
  ...
  @override
  String get kipiQuickBarHint => 'Τι χρειάζεστε για να αγοράσετε;';

  @override
  String replaceItem(String item) {
    return 'Αντικατάσταση $item';
  }
  ...
  String get onboardingHookHeadline =>
      'Μην ξεχάσετε ποτέ ξανά ένα είδος παντοπωλείου';

  @override
  String get onboardingGoalSaveMoney => 'Εξοικονομήστε χρήματα';

  @override
  String get onboardingGoalNeverForget => 'Μην ξεχνάτε ποτέ αντικείμενα';

  @override
  String get onboardingGoalFaster => 'Ψωνίστε πιο γρήγορα';

  @override
  String get onboardingGoalFamily => 'Οργανώστε οικογενειακές αγορές';

  @override
  String get onboardingGoalRecipes => 'Ανακαλύψτε συνταγές';

  @override
  String get onboardingGoalPantry => 'Τροχόσπιτο';

  @override
  String get onboardingCommitmentsTitle => 'Τι σημασία έχει για εσάς;';

  @override
  String get onboardingCommitmentsSubtitle =>
      'Επιλέξτε τους στόχους σας για να εξατομικεύσετε το KipiList';

  @override
  String get onboardingCommitmentsCta => 'Πάμε!';

  @override
  String get onboardingPersonalizationNameLabel => 'Το όνομά σου';

  @override
  String get onboardingPersonalizationNameHint => 'Εισαγάγετε το όνομά σας';

  @override
  String get onboardingPersonalizationCategoryTitle => 'Τι ψωνίζεις;';

  @override
  String get onboardingPersonalizationGroupTitle => 'Για ποιον ψωνίζετε;';

  @override
  String get onboardingCategoryGrocery => 'Είδη παντοπωλείου';

  @override
  String get onboardingCategoryPharmacy => 'Φαρμακείο';

  @override
  String get onboardingCategoryRecipes => 'Συνταγές';

  @override
  String get onboardingCategoryHome => 'Σπίτι';

  @override
  String get onboardingCategoryPet => 'Κατοικίδιο ζώο';

  @override
  String get onboardingGroupSolo => 'Μόνο εγώ';

  @override
  String get onboardingGroupCouple => 'Ζευγάρι';

  @override
  String get onboardingGroupFamily => 'Οικογένεια';

  @override
  String get onboardingLoadingTitle => 'Προετοιμασία της εμπειρίας σας...';

  @override
  String get onboardingLoadingStep1 => 'Αναλύοντας τις προτιμήσεις σας...';

  @override
  String get onboardingLoadingStep2 => 'Ρύθμιση του βοηθού AI...';

  @override
  String get onboardingLoadingStep3 => 'Σχεδόν έτοιμο...';

  @override
  String get onboardingLoadingStat1Label => 'Αντικείμενα καταλογογραφημένα';

  @override
  String get onboardingLoadingStat2Label => 'Οι χρήστες βοήθησαν';

  @override
  String get onboardingLoadingStat3Label => 'Τα λεπτά αποθηκεύτηκαν';

  @override
  String paywallGoalHeadlineSaveMoney(String name) {
    return '$name, εξοικονομήστε χρήματα σε κάθε ταξίδι!';
  }

  @override
  String paywallGoalHeadlineNeverForget(String name) {
    return '$name, μην ξεχνάτε ποτέ ένα αντικείμενο!';
  }

  @override
  String paywallGoalHeadlineFaster(String name) {
    return '$name, ψωνίστε στο μισό χρόνο!';
  }

  @override
  String paywallGoalHeadlineFamily(String name) {
    return '$name, οργανώστε οικογενειακές αγορές!';
  }

  @override
  String paywallGoalHeadlineRecipes(String name) {
    return '$name, ανακαλύψτε νέες συνταγές!';
  }

  @override
  String paywallGoalHeadlinePantry(String name) {
    return '$name, παρακολουθήστε τέλεια το ντουλάπι σας!';
  }

  @override
  String get paywallGoalHeadlineNoNameSaveMoney =>
      'Εξοικονομήστε χρήματα σε κάθε ταξίδι!';

  @override
  String get paywallGoalHeadlineNoNameNeverForget =>
      'Μην ξεχνάτε ποτέ ένα αντικείμενο!';

  @override
  String get paywallGoalHeadlineNoNameFaster => 'Ψωνίστε στο μισό χρόνο!';

  @override
  String get paywallGoalHeadlineNoNameFamily =>
      'Οργανώστε οικογενειακές αγορές!';

  @override
  String get paywallGoalHeadlineNoNameRecipes => 'Ανακαλύψτε νέες συνταγές!';

  @override
  String get paywallGoalHeadlineNoNamePantry =>
      'Παρακολουθήστε τέλεια το ντουλάπι σας!';

  @override
  String paywallPricePerDay(String price) {
    return 'Μόνο $price/ημέρα — λιγότερο από έναν καφέ';
  }
  ...
  @override
  String get paywallSkipNow => 'Παράλειψη προς το παρόν';

  @override
  String get paywallTestimonial =>
      'Το AI οργανώνει τις αγορές μου σε δευτερόλεπτα. Εξοικονομώ 20 λεπτά ανά ταξίδι.';

  @override
  String get paywallTestimonialAuthor => 'Ανν Σ.';

  @override
  String get paywallTrialDisclaimer =>
      'Ακύρωση ανά πάσα στιγμή · Χωρίς χρέωση μέχρι τη λήξη της δοκιμής σας';

  @override
  String onboardingAiDemoGreeting(String name, String category) {
    return 'Γεια $name! Τι $category χρειάζεστε;';
  }

  @override
  String onboardingAiDemoGreetingNoName(String category) {
    return 'Τι $category χρειάζεστε;';
  }

  @override
  String get onboardingAiDemoYes => 'Ναί!';

  @override
  String get onboardingAiDemoReaction => 'Ομορφη!';

  @override
  String get onboardingAiDemoChange => 'Αλλαγή στοιχείου';

  @override
  String get onboardingAiDemoOffer => 'Δοκιμάστε να πληκτρολογήσετε κάτι άλλο!';

  @override
  String get onboardingAiDemoContinue => 'Συνεχίζω';

  @override
  String get onboardingAiDemoSlideHeadline => 'Η λίστα αγορών σας, τώρα με AI';

  @override
  String get onboardingAiDemoSlideSubtitle =>
      'Δείτε πώς η Kipi δημιουργεί την πλήρη λίστα σας σε δευτερόλεπτα';

  @override
  String get onboardingAiDemoSlideCta => 'Θέλω αυτό! →';

  @override
  String get onboardingAiDemoSlideUserMsg => 'Φιλοξενώ μπάρμπεκιου 🔥';

  @override
  String get onboardingAiDemoSlideReady =>
      'Ετοιμος! Εδώ είναι όλα όσα χρειάζεστε:';

  @override
  String get onboardingAiDemoSlideDone =>
      'Ολοκληρώστε τη λίστα σε δευτερόλεπτα ✨';

  @override
  String get onboardingPainTitle => 'Τι σε απογοητεύει περισσότερο;';

  @override
  String get onboardingPainSubtitle =>
      'Να είστε ειλικρινείς - θα το φτιάξουμε το καθένα';

  @override
  String get onboardingPainCta => 'Ναι, διορθώστε μου αυτό →';

  @override
  String get onboardingPainForget => 'Ξεχνώ αντικείμενα στο κατάστημα';

  @override
  String get onboardingPainFamily =>
      'Η οικογένειά μου δεν βλέπει ποτέ τη λίστα';

  @override
  String get onboardingPainOverspend => 'Πάντα ξεπερνώ τον προϋπολογισμό';
  ...
  @override
  String get recipeIngredientSingular => '1 συστατικό';
  ...
  @override
  String get pantryAvailabilityAll => 'Όλα έτοιμα!';

  @override
  String pantryAvailabilityCount(int availableCount, int totalCount) {
    return '$availableCount/$totalCount σε ντουλάπι';
  }
  ...
  String get onboardingDemoHeadline =>
      'Πες μας τι σχεδιάζεις. Ο Kipi φτιάχνει τη λίστα.';

  @override
  String get onboardingDemoSubtitle =>
      'Αποκτήστε οργανωμένα αντικείμενα σε δευτερόλεπτα.';

  @override
  String get onboardingPersonalizationEffect =>
      'Αυτό βοηθά την Kipi να προτείνει πιο σχετικά είδη και ποσότητες.';

  @override
  String get onboardingPersonalizeWithName => 'Εξατομίκευση με το όνομά μου';

  @override
  String get onboardingCreateFirstList => 'Δημιουργήστε την πρώτη μου λίστα';

  @override
  String get onboardingPromptWeekly =>
      'Προγραμματίστε τα απαραίτητα για την εβδομάδα';

  @override
  String get onboardingPromptEvent => 'Ετοιμάζω κάτι ιδιαίτερο';

  @override
  String get onboardingPromptEssentials => 'Πρότεινε τα απαραίτητα για μένα';

  @override
  String get onboardingFallbackGrocery =>
      '🍚 Ρύζι|🫘 Φασόλια|🥛 Γάλα|🥚 Αυγά|🍞 Ψωμί|🍎 Φρούτα';

  @override
  String get onboardingFallbackPharmacy =>
      '🩹 Αυτοκόλλητοι επίδεσμοι|🌡️ Θερμόμετρο|🧴 Αντισηπτικό|😷 Μάσκες προσώπου|🧼 Απολυμαντικό χεριών';

  @override
  String get onboardingFallbackRecipes =>
      '🍅 Ντομάτες|🧅 Κρεμμύδι|🧄 Σκόρδο|🥚 Αυγά|🧀 Τυρί|🌿 Φρέσκα μυρωδικά';

  @override
  String get onboardingFallbackHome =>
      '🧻 Χαρτοπετσέτες|🧽 Σφουγγάρια|🧴 Απορρυπαντικό|🗑️ Σακούλες σκουπιδιών|';

  @override
  String get onboardingFallbackPet =>
      '🥣 Τροφές για κατοικίδια|🦴 Λιχουδιές|🧼 Σαμπουάν για κατοικίδια|🧸 Παιχνίδι|🧻 Σακούλες απορριμμάτων';

  @override
  String get onboardingListSaveFailed =>
      'Ετοίμασα τα αντικείμενα, αλλά δεν μπόρεσα να αποθηκεύσω τη λίστα. Προσπαθήστε ξανά να το διατηρήσετε στην εφαρμογή.';

  @override
  String onboardingListCreated(int count) {
    return 'Η λίστα σας είναι έτοιμη: $count αντικείμενα οργανωμένα για εσάς.';
  }

  @override
  String get onboardingContinueToOffer => 'Συνεχίζω';

  @override
  String onboardingPaywallListReady(int count) {
    return 'Η πρώτη σας λίστα είναι έτοιμη · $count στοιχεία';
  }

  @override
  String get paywallContinueFree => 'Συνεχίστε με τη δωρεάν έκδοση';

  @override
  String get paywallPurchasePending =>
      'Η πληρωμή σας εκκρεμεί έγκριση. Η πρόσβαση θα απελευθερωθεί αυτόματα μετά την επιβεβαίωση.';

  @override
  String paywallTrialDisclosureAnnual(int days, String price) {
    return 'Σήμερα: χωρίς χρέωση. Στη συνέχεια $price/έτος μετά από $days ημέρες. Ακύρωση ανά πάσα στιγμή.';
  }

  @override
  String paywallTrialDisclosureMonthly(int days, String price) {
    return 'Σήμερα: χωρίς χρέωση. Στη συνέχεια $price/μήνα μετά από $days ημέρες. Ακύρωση ανά πάσα στιγμή.';
  }

  @override
  String paywallBillingAnnual(String price) {
    return '$price/έτος. Ακύρωση ανά πάσα στιγμή.';
  }

  @override
  String paywallBillingMonthly(String price) {
    return '$price/μήνα. Ακύρωση ανά πάσα στιγμή.';
  }

  @override
  String get obHookTitle => 'Οι πιο έξυπνες αγορές ξεκινούν εδώ';

  @override
  String get obHookSubtitle =>
      'Λίστες με τεχνητή νοημοσύνη που σας εξοικονομούν χρόνο και χρήμα, σε κάθε ταξίδι.';

  @override
  String get obHookSocial =>
      'Εμπιστεύονται χιλιάδες αγοραστές σε όλο τον κόσμο';

  @override
  String get obHookCta => 'Ξεκινήστε';

  @override
  String get obQuizHouseholdTitle => 'Για ποιον ψωνίζετε;';

  @override
  String get obQuizHouseholdSolo => 'Μόνο εγώ';

  @override
  String get obQuizHouseholdCouple => 'Εγώ και ο σύντροφός μου';

  @override
  String get obQuizHouseholdFamilySmall => 'Οικογένεια 3–4 ατόμων';

  @override
  String get obQuizHouseholdFamilyLarge => 'Οικογένεια 5+';

  @override
  String get obQuizFrequencyTitle => 'Πόσο συχνά ψωνίζετε για παντοπωλεία;';

  @override
  String get obQuizFrequencyDaily => 'Σχεδόν κάθε μέρα';

  @override
  String get obQuizFrequencyWeekly => 'Μια φορά την εβδομάδα';

  @override
  String get obQuizFrequencyBiweekly => 'Κάθε δύο εβδομάδες';

  @override
  String get obQuizFrequencyMonthly => 'Μεγάλες μηνιαίες αποστολές';

  @override
  String get obQuizPainTitle => 'Τι σας απογοητεύει περισσότερο στις αγορές;';

  @override
  String get obQuizPainForget => 'Ξεχνώ πάντα αντικείμενα';

  @override
  String get obQuizPainOverspend =>
      'Ξοδεύω περισσότερα από τα προγραμματισμένα';

  @override
  String get obQuizPainWaste => 'Το φαγητό πάει χαμένο στο σπίτι';

  @override
  String get obQuizPainTime => 'Παίρνει πάρα πολύ χρόνο';

  @override
  String get obQuizSavingsTitle =>
      'Πόσα χρήματα θα θέλατε να εξοικονομείτε μηνιαία;';

  @override
  String get obQuizSavingsSmall => 'Λίγο - κάθε κομμάτι μετράει';

  @override
  String get obQuizSavingsMedium =>
      'Περίπου το 10% του λογαριασμού μου για τα παντοπωλεία';

  @override
  String get obQuizSavingsLarge => 'Όσο το δυνατόν περισσότερο';

  @override
  String get obQuizMethodTitle => 'Πώς φτιάχνετε λίστες για ψώνια σήμερα;';

  @override
  String get obQuizMethodPaper => 'Στυλό και χαρτί';

  @override
  String get obQuizMethodNotes => 'Εφαρμογή σημειώσεων';

  @override
  String get obQuizMethodMemory => 'Το κρατάω στο κεφάλι μου';

  @override
  String get obQuizMethodNone => 'Δεν κάνω λίστες';

  @override
  String get obSocialTitle => 'Είσαι σε καλή παρέα';

  @override
  String get obSocialSubtitle =>
      'Αγοραστές σαν εσάς κάνουν ήδη οικονομία με το KipiList';

  @override
  String get obSocialQuote1 =>
      'Δεν ξεχνώ ποτέ τίποτα πια. Το AI δημιουργεί τη λίστα μου σε δευτερόλεπτα.';

  @override
  String get obSocialQuote2 =>
      'Κόψαμε αισθητά τον λογαριασμό του παντοπωλείου μας τον πρώτο μήνα.';

  @override
  String get obSocialQuote3 =>
      'Η κοινή χρήση της λίστας με τον σύντροφό μου έληξε το χάος των αγορών μας.';

  @override
  String get obLoadingTitle => 'Χτίζοντας το εξατομικευμένο σας σχέδιο...';

  @override
  String get obLoadingStepProfile => 'Προσαρμογή για το νοικοκυριό σας';

  @override
  String get obLoadingStepHabits => 'Συντονιστείτε στη ρουτίνα αγορών σας';

  @override
  String get obLoadingStepSavings =>
      'Βελτιστοποίηση της στρατηγικής αποταμίευσης';

  @override
  String get obLoadingStepLists => 'Ετοιμάζοντας τις έξυπνες λίστες σας';

  @override
  String get obRevealTitle => 'Το σχέδιό σας είναι έτοιμο!';

  @override
  String get obRevealSubtitle =>
      'Δείτε πώς θα λειτουργήσει το KipiList για εσάς';

  @override
  String get obRevealSavingsCaption =>
      'Προβλεπόμενη εξοικονόμηση με το KipiList';
  ...
  String get obRevealFeatureAi =>
      'Το AI δημιουργεί και οργανώνει τις λίστες σας';

  @override
  String get obRevealFeatureBudget =>
      'Οι δαπάνες παρακολουθούνται σε σχέση με τον στόχο σας';

  @override
  String get obRevealFeaturePantry =>
      'Η παρακολούθηση αποθηκών μειώνει τη σπατάλη τροφίμων';

  @override
  String get obRevealFeatureShare =>
      'Κοινή χρήση σε πραγματικό χρόνο με το νοικοκυριό σας';

  @override
  String get obPaywallTitle => 'Ξεκλειδώστε το σχέδιό σας';

  @override
  String get obPaywallRetry => 'Προσπαθήστε ξανά';

  @override
  String get obLoginTitle => 'Αποθηκεύστε το σχέδιό σας';

  @override
  String get obLoginSubtitle =>
      'Συνδεθείτε ώστε οι λίστες σας να συγχρονίζονται μεταξύ των συσκευών';

  @override
  String get obLoginGoogle => 'Συνεχίστε με την Google';

  @override
  String get obLoginApple => 'Συνεχίστε με την Apple';

  @override
  String get obLoginSkip => 'Όχι τώρα';
