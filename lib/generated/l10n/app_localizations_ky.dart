...
class AppLocalizationsKy extends AppLocalizations {
  ...
  @override
  String get aiSection => 'AI жардамчысы';
  ...
  @override
  String get chooseThemeMode => 'Тема режимин тандоо';
  ...
  @override
  String get keepAdding => 'Кошууну улантыңыз';

  @override
  String get keepAddingSubtitle =>
      'Бир нече нерсени кошуу үчүн баракты ачык кармаңыз';
  ...
  String get chatEmptySubtitle =>
      'Баштоо үчүн сунуштарды, рецепттерди же сактоо боюнча кеңештерди сураңыз.';

  @override
  String get chatEmptyTitle => 'Сиздин маегиңиз бош';
  ...
  @override
  String get goodResponse => 'Жакшы жооп';

  @override
  String get badResponse => 'Жаман жооп';

  @override
  String get scrollToBottom => 'Төмөнгө сыдырыңыз';

  @override
  String get somethingWentWrong => 'Бир жерден ката кетти';

  @override
  String get editMessage => 'Кабарды түзөтүү';

  @override
  String get searchConversations => 'Сүйлөшүүлөрдү издөө';

  @override
  String get dateGroupToday => 'Бүгүн';

  @override
  String get dateGroupYesterday => 'Кечээ';

  @override
  String get dateGroupPrevious7Days => 'Мурунку 7 күн';

  @override
  String get dateGroupOlder => 'Улгайган';
  ...
  @override
  String get newChatStarted => 'Жаңы чат башталды';

  @override
  String get quickAddToList => 'Тизмеге кошуу';

  @override
  String get aiCapabilitiesTitle => 'Мен эмне кылсам болот?';

  @override
  String get aiCapabilitiesLists => 'Соода тизмелери';

  @override
  String get aiCapabilitiesBudget => 'Бюджет жана баалар';

  @override
  String get aiCapabilitiesRecipes => 'Рецепттер жана менюлар';

  @override
  String get aiCapabilitiesOrganize => 'Уюштуруу';

  @override
  String get marketModeDescription => 'Дүкөндө буюмдарды текшериңиз';
  ...
  String get recipeAddError =>
      'Тизмеңизге кошулган жок. Сураныч, кайра аракет кылыңыз.';

  @override
  String get recipeTapToCheck =>
      'Бышыруу учурунда аны текшерүү үчүн ингредиентти таптап коюңуз';

  @override
  String get recipeIngredientInPantry => 'Ашканада';

  @override
  String get recipeIngredientLowPantry => 'Кампада аз';
  ...
  @override
  String get paywallTimelineToday => 'Бүгүн';

  @override
  String get paywallTimelineTodayDesc => 'Толук мүмкүнчүлүктү заматта ачыңыз';
  ...
  String get paywallTimelineReminderDesc =>
      'Сот процесси аяктаганга чейин эскертебиз';

  @override
  String get paywallTimelineChargeDesc =>
      'Жазылууңуз башталат — каалаган убакта жокко чыгарыңыз';
  ...
  String get paywallHeroFeatureDesc =>
      'Бүт тизмени сүйлөңүз же чаптаңыз — AI аны секунданын ичинде сорттойт, категорияларга бөлөт жана бюджетке салат';

  @override
  String get paywallBasedOnAnswers => 'Жоопторуңуздан жекелештирилген';
  ...
  @override
  String get pantryItemAdded => 'Элемент кошулду';
  ...
  @override
  String get recipeYieldServings => 'Түшүм порциялары';

  @override
  String get recipeManualTotalCost => 'Кол менен жалпы наркы';

  @override
  String get recipeManualTotalCostHint =>
      'Ингредиенттердин баасын эсептөө үчүн бош калтырыңыз.';

  @override
  String get recipeEstimatedTotalCost => 'Болжолдуу жалпы наркы';
  ...
  String recipeServesCount(int count) {
    return '$count кызмат кылат';
  }

  @override
  String get recipeEstimatePartial =>
      'Баасы менен ингредиенттердин негизинде жарым-жартылай баа.';
  ...
  String get mealPlannerEstimatePartial =>
      'Жарым-жартылай баа маалыматтары менен рецепттердин негизинде баалоо.';
  ...
  @override
  String get mealPlannerBudgetRemoveGoal => 'Максатты алып салуу';

  @override
  String get mealPlannerBudgetGoalNav => 'Тамактанууну пландаштыруучу бюджет';

  @override
  String get mealPlannerBudgetGoalSubtitle =>
      'Тамактанууну пландаштыруу үчүн айлык чыгымдоо максаты';
  ...
  @override
  String get catalogRareBadge => 'Сейрек';
  ...
  @override
  String get mealPlannerManageTypes => 'Тамактын түрлөрүн башкарыңыз';

  @override
  String get mealPlannerAddType => 'тамак түрүн кошуу';

  @override
  String get mealPlannerEditType => 'Тамактын түрүн түзөтүү';
  ...
  String get mealPlannerTypeDeleteConfirm =>
      'Бул тамак түрүн чын эле жок кылгыңыз келеби? Бул түрү менен пландаштырылган тамактар ​​калат.';

  @override
  String get mealPlannerTypeNameEmpty => 'Аты бош болбошу керек';

  @override
  String get mealPlannerTypeDeleteError =>
      'Бул тамак түрүн жок кылуу мүмкүн эмес.';

  @override
  String get mealPlannerCustomTypeLabel => 'Ыңгайлаштырылган түрү';
  ...
  @override
  String get errorLoadingItems => 'Элементтерди жүктөө катасы';
  ...
  @override
  String get categoryIconLabel => 'Белги';
  ...
  @override
  String get pantryAvailabilityAll => 'Баары даяр!';

  @override
  String pantryAvailabilityCount(int availableCount, int totalCount) {
    return '$availableCount/$totalCount кампада';
  }
  ...
  String get onboardingDemoHeadline =>
      'Эмнени пландаштырып жатканыңызды айтыңыз. Kipi тизмени тузет.';

  @override
  String get onboardingDemoSubtitle =>
      'Бир нече секунданын ичинде иреттелген нерселерди алыңыз.';

  @override
  String get onboardingPersonalizationEffect =>
      'Бул Kipi көбүрөөк тиешелүү элементтерди жана өлчөмдөрдү сунуш кылууга жардам берет.';

  @override
  String get onboardingPersonalizeWithName => 'Менин атым менен жекелештирүү';

  @override
  String get onboardingCreateFirstList => 'Менин биринчи тизмемди түзүңүз';

  @override
  String get onboardingPromptWeekly =>
      'Апталык керектүү нерселерди пландаштырыңыз';

  @override
  String get onboardingPromptEvent => 'Мен өзгөчө бир нерсе даярдап жатам';

  @override
  String get onboardingPromptEssentials =>
      'Мага керектүү нерселерди сунуштаңыз';

  @override
  String get onboardingFallbackGrocery =>
      '🍚 Күрүч|🫘 Фасоль|🥛 Сүт|🥚 Жумуртка|🍞 Нан|🍎 Жемиштер';

  @override
  String get onboardingFallbackPharmacy =>
      '🩹 Желим бинттер|🌡️ Термометр|🧴 Антисептик|😷 Бет маскалары|🧼 Колду тазалоочу каражат';

  @override
  String get onboardingFallbackRecipes =>
      '🍅 Помидор|🧅 Пияз|🧄 Сарымсак|🥚 Жумуртка|🧀 Сыр|🌿 Жаңы чөптөр';

  @override
  String get onboardingFallbackHome =>
      '🧻 Кагаз сүлгү|🧽 Губкалар|🧴 Жуучу каражат|🗑️ Таштанды баштыктары|🧹 Тазалоочу кездемелер';

  @override
  String get onboardingFallbackPet =>
      '🥣 Үй жаныбарларына арналган тамактар|🦴 Дарылар|🧼 Үй жаныбарлары үчүн шампунь|🧸 Оюнчуктар|🧻 Таштанды баштыктары';

  @override
  String get onboardingListSaveFailed =>
      'Мен нерселерди даярдадым, бирок тизмени сактай албадым. Аны колдонмодо сактоо үчүн кайра аракет кылыңыз.';

  @override
  String onboardingListCreated(int count) {
    return 'Тизмеңиз даяр: $count нерселер сиз үчүн уюштурулган.';
  }

  @override
  String get onboardingContinueToOffer => 'Улантуу';

  @override
  String onboardingPaywallListReady(int count) {
    return 'Биринчи тизмеңиз даяр · $count нерсе';
  }

  @override
  String get paywallContinueFree => 'Акысыз версия менен улантыңыз';

  @override
  String get paywallPurchasePending =>
      'Төлөмүңүз бекитилишин күтүүдө. Кирүү уруксаты ырасталгандан кийин автоматтык түрдө чыгарылат.';

  @override
  String paywallTrialDisclosureAnnual(int days, String price) {
    return 'Бүгүн: төлөм жок. Андан кийин $price/жыл $days күндөн кийин. Каалаган убакта жокко чыгарыңыз.';
  }

  @override
  String paywallTrialDisclosureMonthly(int days, String price) {
    return 'Бүгүн: төлөм жок. Андан кийин $price/айына $days күндөн кийин. Каалаган убакта жокко чыгарыңыз.';
  }

  @override
  String paywallBillingAnnual(String price) {
    return '$price/жыл. Каалаган убакта жокко чыгарыңыз.';
  }

  @override
  String paywallBillingMonthly(String price) {
    return '$price/ай. Каалаган убакта жокко чыгарыңыз.';
  }

  @override
  String get obHookTitle => 'Акылдуу соода ушул жерден башталат';

  @override
  String get obHookSubtitle =>
      'Убакытты жана акчаңызды үнөмдөөчү AI менен иштеген тизмелер, ар бир сапар.';

  @override
  String get obHookSocial =>
      'Дүйнө жүзү боюнча миңдеген сатып алуучулар ишенет';

  @override
  String get obHookCta => 'Баштоо';

  @override
  String get obQuizHouseholdTitle => 'Сиз кимге дүкөн кыласыз?';

  @override
  String get obQuizHouseholdSolo => 'Мен эле';

  @override
  String get obQuizHouseholdCouple => 'Мен жана менин өнөктөшүм';

  @override
  String get obQuizHouseholdFamilySmall => '3–4 адамдан турган үй-бүлө';

  @override
  String get obQuizHouseholdFamilyLarge => '5+ үй-бүлө';

  @override
  String get obQuizFrequencyTitle => 'Сиз канча жолу азык-түлүк сатып аласыз?';

  @override
  String get obQuizFrequencyDaily => 'Дээрлик күн сайын';

  @override
  String get obQuizFrequencyWeekly => 'Аптасына бир жолу';

  @override
  String get obQuizFrequencyBiweekly => 'Ар эки жумада';

  @override
  String get obQuizFrequencyMonthly => 'Ай сайын чоң жүк';

  @override
  String get obQuizPainTitle => 'Сатып алууда сизди эмне капалантат?';

  @override
  String get obQuizPainForget => 'Мен буюмдарды дайыма унутуп калам';

  @override
  String get obQuizPainOverspend => 'Пландан ашык чыгымдаймын';

  @override
  String get obQuizPainWaste => 'Тамак-аш үйдө текке кетет';

  @override
  String get obQuizPainTime => 'Бул өтө көп убакытты талап кылат';

  @override
  String get obQuizSavingsTitle => 'Ай сайын канча үнөмдөп калгыңыз келет?';

  @override
  String get obQuizSavingsSmall => 'Бир аз - ар бир бит эсептелет';

  @override
  String get obQuizSavingsMedium =>
      'Менин азык-түлүк эсебимдин болжол менен 10%';

  @override
  String get obQuizSavingsLarge => 'Мүмкүн болушунча';

  @override
  String get obQuizMethodTitle => 'Бүгүн соода тизмелерин кантип түзөсүз?';

  @override
  String get obQuizMethodPaper => 'Калем жана кагаз';

  @override
  String get obQuizMethodNotes => 'Notes колдонмосу';

  @override
  String get obQuizMethodMemory => 'Мен аны башымда сактайм';

  @override
  String get obQuizMethodNone => 'Мен тизме түзбөйм';

  @override
  String get obSocialTitle => 'Сиз жакшы мамиледесиз';

  @override
  String get obSocialSubtitle =>
      'Сизге окшогон сатып алуучулар KipiList менен үнөмдөп жатышат';

  @override
  String get obSocialQuote1 =>
      'Мен мындан ары эч нерсени унутпайм. AI менин тизмемди секунданын ичинде түзөт.';

  @override
  String get obSocialQuote2 =>
      'Биз биринчи айда эле азык-түлүк эсебин азайттык.';

  @override
  String get obSocialQuote3 =>
      'Тизмени өнөктөшүм менен бөлүшүү биздин соода башаламандыгын токтотту.';

  @override
  String get obLoadingTitle => 'Жекелештирилген планыңыз түзүлүүдө...';

  @override
  String get obLoadingStepProfile => 'Сиздин үй-бүлө үчүн тууралоо';

  @override
  String get obLoadingStepHabits => 'Соода тартибин тууралоо';

  @override
  String get obLoadingStepSavings => 'Сактоо стратегияңызды оптималдаштыруу';

  @override
  String get obLoadingStepLists => 'Акылдуу тизмелериңизди даярдоо';

  @override
  String get obRevealTitle => 'Планыңыз даяр!';

  @override
  String get obRevealSubtitle => 'Бул жерде KipiList сиз үчүн кандай иштейт';

  @override
  String get obRevealSavingsCaption => 'KipiList менен болжолдонгон үнөмдөө';
  ...
  @override
  String get obRevealFeatureAi => 'AI тизмелериңизди түзөт жана уюштурат';

  @override
  String get obRevealFeatureBudget =>
      'Сиздин максатыңызга каршы чыгашаңыз байкалды';

  @override
  String get obRevealFeaturePantry =>
      'Ашканага көз салуу тамак-аш калдыктарын азайтат';

  @override
  String get obRevealFeatureShare =>
      'Үй-бүлөңүз менен реалдуу убакытта бөлүшүү';

  @override
  String get obPaywallTitle => 'Планыңыздын кулпусун ачыңыз';

  @override
  String get obPaywallRetry => 'Кайра аракет кыл';

  @override
  String get obLoginTitle => 'Планыңызды сактаңыз';

  @override
  String get obLoginSubtitle =>
      'Тизмелериңиз бардык түзмөктөрдө шайкештеши үчүн аккаунтуңузга кириңиз';

  @override
  String get obLoginGoogle => 'Google менен улантыңыз';

  @override
  String get obLoginApple => 'Apple менен улантыңыз';

  @override
  String get obLoginSkip => 'Азыр эмес';

  @override
  String get obLoginError =>
      'Кирүү ишке ашкан жок. Кайталап көрүңүз же азыр өткөрүп жибериңиз.';

  @override
  String get searchMessages => 'Билдирүүлөрдү издөө...';

  @override
  String get deletedList => 'Жок кылынган тизме';

  @override
  String get openConversation => 'Ачык сүйлөшүү';

  @override
  String get userRole => 'сен';

  @override
  String get assistantRole => 'Жардамчы';

  @override
  String get agentActionsRunning => 'Иштеп жаткан аракеттер...';

  @override
  String get agentActionsFailed => 'Аракеттер аткарылбай калды';

  @override
  String get agentActionsPremium => 'Аракеттерге Premium талап кылынат';
  ...
  @override
  String get undoChanges => 'Өзгөртүүлөрдү жокко чыгаруу';
  ...
  @override
  String get itemAddedToList => 'Тизмеге кошулган нерсе.';
  ...
  String previousItemState(
    ...
    return 'Мурунку абалы: $quantity $unit [$category]$price';
  }
  ...
  String get premiumActionsPrompt =>
      'Автоматтык аракеттердин кулпусун ачуу үчүн Premium\'га жазылыңыз.';

  @override
  String get viewPlans => 'Пландарды көрүү';

  @override
  String get artifactSynced => 'Шайкештирилди';

  @override
  String get artifactBudgetLabel => 'Бюджет:';

  @override
  String get totalEstimatedLabel => 'Болжолдуу жалпы';

  @override
  String get quickActionPantry => 'Кампаны көрүү';

  @override
  String get quickActionAi => 'Kipi менен баарлашуу';

  @override
  String aiApiError(int statusCode) {
    return 'AI кызматы ката кайтарды ($statusCode).';
  }

  @override
  String get aiTimeoutError =>
      'Өтүнүч өтө көпкө созулду. Сураныч, кайра аракет кылыңыз.';

  @override
  String get aiConnectionError =>
      'AI кызматына туташа алган жок. Байланышыңызды текшериңиз.';

  @override
  String get aiEmptyResponseError => 'AI кызматы бош жооп кайтарды.';

  @override
  String get aiInvalidResponseError => 'AI кызматы жараксыз жооп кайтарды.';

  @override
  String get categoryFruits => 'Жемиштер';

  @override
  String get categoryCleaning => 'Тазалоо';

  @override
  String get categoryBeverages => 'Суусундуктар';

  @override
  String get categoryBakery => 'Наабайкана';
  ...
  @override
  String get categoryVegetables => 'Жашылчалар';

  @override
  String get categoryGrains => 'Дан жана дан эгиндери';

  @override
  String get categoryHygiene => 'Жеке кам көрүү';

  @override
  String get categoryFrozen => 'Тоңдурулган тамактар';

  @override
  String get categoryCanned => 'Консерваланган товарлар';

  @override
  String get categorySeasonings => 'Татымалдар';

  @override
  String get categorySweets => 'Таттуулар жана десерттер';

  @override
  String get categoryAlcohol => 'Алкоголдук ичимдиктер';

  @override
  String get categoryFish => 'Балык';

  @override
  String get categoryColdCuts => 'Cold cuts';

  @override
  String get categoryUtilities => 'Үй буюмдары';

  @override
  String get categoryPet => 'Үй жаныбарлары';

  @override
  String get categoryBaby => 'Baby';

  @override
  String get categoryOthers => 'Башка';

  @override
  String chatEmptyGreeting(String name) {
    return 'Салам $name, мен Kipiмин 👋';
  }

  @override
  String get chatEmptyGreetingNoName => 'Салам, мен Kipi 👋';

  @override
  String get chatEmptyPitch =>
      'Мен тизмелерди түзөм, рецепттерди сунуштайм жана сактаган жерди табам. Биз эмнеден баштайбыз?';

  @override
  String get aiWelcomeSuggestBarbecue => 'Барбекю пландаңыз';

  @override
  String get aiWelcomeSuggestBarbecuePrompt =>
      'Kipi, мен барбекю жасап жатам — мага соода тизмесин түзүүгө жардам бер';

  @override
  String get aiRateLimitError =>
      'Кыска убакыттын ичинде өтө көп билдирүүлөр. Бир нече секунд күтүп, кайра аракет кылыңыз.';

  @override
  String get chatHistoryErrorTitle => 'Бул маек жүктөлгөн жок';

  @override
  String get chatHistoryErrorBody =>
      'Бир жерден ката кетти. Кайра аракет кылуу үчүн таптап коюңуз.';

  @override
  String get chatHistoryOfflineTitle => 'Сиз оффлайндасыз';
